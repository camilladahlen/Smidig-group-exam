        ...
        <div className="column is-9">
          <div className="columns is-vcentered">
            ...
            <div className="column" style={{ transform: "scale(0.5)" }}>
              <img className="dnbLogo" src={Dnb} alt={"Dnb Logo"} />
            </div>
            <div className="column" style={{ transform: "scale(0.5)" }}>
              <img className="dnvLogo" src={Dnv} alt={"Dnv Logo"} />
            </div>
            <div className="column" style={{ transform: "scale(0.5)" }}>
            ...
            <div className="column" style={{ transform: "scale(0.5)" }}>
              <img className="enturLogo" src={Entur} alt={"Entur Logo"} />
            </div>
          </div>
          ...
          <div className="columns">
            ...
            <div className="column has-text-left">
              ...
              <div
                className="siteList has-text-left"
            ...
            <div className="column">
              ...
              <div
                className="socialList has-text-left"
                style={{ listStyleType: "none" }}
              >
                <a href="#">Facebook</a>
                <br />
          ...
          <div className="columns">
            <div
              className="column has-text-centered is-size-7"
              style={{ marginTop: "2%" }}
            >
              <p className="text">
                © 2021 by Meliora Impact. Org.nr 926 638 564
              </p>
            </div>
          </div>
        </div>
